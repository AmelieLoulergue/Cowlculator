const listOfQuestions = {
  formQuestions: [
      ...
      linked_questions: [
        {
          ...
          formInput: { type: "number" },
          userValue: { value: 0, unit: "barrel (1 oil barrel = 42 US gal)" },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      question:
        "Do you have your soil tested for its carbon content? e.g. dry combustion or elemental analysis",
      formInput: { type: "checkbox" },
      userValue: false,
      linked_questions: [
        {
          ...
          id: "soil_test_number",
          question:
            "How many soil test result(s) including the carbon content of you soil do you have ?",

          formInput: { type: "select" },
          userValue: ["1", "more than 1"],
        },
      ],
    },
    {
