        ...
        <div className="formChat">
            ...
            <div className="questions">
                ...
                <div className="response fadeInBottom delay-05">
                    <p contentEditable={true} suppressContentEditableWarning={true}>And your sended response here</p>
                </div>
                <div className="response following-response fadeInBottom delay-15">
                    <p contentEditable={true} suppressContentEditableWarning={true}>Note that all your responses are editable</p>
                </div>
