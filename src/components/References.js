...
function References() {
  return (
    <>
      <div className="container" id="ref">
        <h1 className="primaryTitle">References</h1>
        <p className="subTitle">
          Take a look into our references to learn more
        </p>
        <br></br>
        <div className="ref-section">
          <h2>IPCC 2021 report</h2>
          <div className="card-section">
            <div className="card">
              <h3>AR6 Climate Change 2021</h3>
              <p>
            ...
            <div className="card">
              <h3>Climate Change 2021</h3>
              <p>
                Climate Change 2021 The Physical Science Basis Summary for
        ...
        <div className="ref-section">
          <h2>GHG emissions data</h2>
          <div className="card-section">
            <div className="card">
              <h3>Global Greenhouse Gas Emissions Data</h3>
              <p>
                Global Greenhouse Gas Emissions Data, 2021, United States
        ...
        <div className="ref-section">
          <h2>
            CO<sub>2</sub> emissions coefficients by fuel
          </h2>
          <div className="card-section">
            <div className="card">
        ...
        <div className="ref-section">
          ...
          <div className="card-section">
            ...
            <div className="card">
              ...
              <p>
                ICF for United States Environmental Protection Agency (EPA),
                2020,User’s guide for estimating carbon dioxide, methane, and
                nitrous oxide emissions from agriculture using the state
                inventory tool,{" "}
              </p>
              <a
                target="_blank"
          ...
          <div className="card-section">
            ...
            <div className="card">
              ...
              <p>
                ...
                factors and their variability, Journal of Environmental
                Management
              </p>
            </div>
          </div>
